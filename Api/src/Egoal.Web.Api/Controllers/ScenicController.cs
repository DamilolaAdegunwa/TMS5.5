...
namespace Egoal.Web.Api.Controllers
{
    public class ScenicController : TmsControllerBase
    {
        ...
        [HttpGet]
        public async Task<JsonResult> GetScenicAsync()
        {
            var result = await _scenicAppService.GetScenicAsync();
        ...
        [HttpGet]
        public async Task<JsonResult> GetGateComboBoxItemsAsync()
        {
            var result = await _scenicAppService.GetGateComboBoxItemsAsync();
        ...
        [HttpGet]
        [AllowAnonymous]
        public JsonResult GetWxTouristNeedCertTypeFlag()
        {
            var result = _scenicAppService.GetWxTouristNeedCertTypeFlag();
            return Json(result);
        }

        [HttpGet]
        [AllowAnonymous]
        public JsonResult GetScenicObject()
        {
            var result = _scenicAppService.GetScenicObject();
            return Json(result);
        }
    }
}
