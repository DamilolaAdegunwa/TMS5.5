...
namespace Egoal.Tickets
{
    public static class SaleTicketInputExtensions
    {
        public static TicketSale MapToTicketSale(this SaleTicketInput input)
        {
            ...
            ticketSale.PromoterId = input.PromoterId;
            ...
            ticketSale.TradeSource = input.TradeSource;
        ...
        public static Trade MapToTrade(this SaleTicketInput input)
        {
            ...
            trade.PromoterId = input.PromoterId;
            ...
            trade.ContactName = input.ContactName;
            trade.Mobile = input.ContactMobile;
            trade.ContactCertNo = input.ContactCertNo;
        ...
        public static SaleTicketInput MapToSaleTicketInput(this Order order)
        {
            ...
            saleTicketInput.PromoterId = order.PromoterId;
            saleTicketInput.ContactName = order.YdrName;
            saleTicketInput.ContactMobile = order.Mobile;
            saleTicketInput.ContactCertTypeId = order.CertTypeId;
            saleTicketInput.ContactCertNo = order.CertNo;
