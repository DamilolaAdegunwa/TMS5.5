...
namespace Egoal.Trades
{
    public interface ITradeAppService
    {
        ...
        Task<byte[]> StatPayDetailByCustomerToExcelAsync(StatPayDetailByCustomerInput input);
        Task<DynamicColumnResultDto> StatPayDetailByCustomerAsync(StatPayDetailByCustomerInput input);
    }
}
