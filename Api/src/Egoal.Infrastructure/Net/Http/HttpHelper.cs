...
namespace Egoal.Net.Http
{
    public static class HttpHelper
    {
        ...
        {
            return await PostStringAsync(url, json, encoding, "application/json");
        }
        ...
        {
            return await PostStringAsync(url, xml, encoding, "text/xml");
        }
        ...
        {
            return await SendAsync(url, data, encoding, encoding, "POST", $"application/x-www-form-urlencoded;charset={encoding.WebName}");
        }

        public static async Task<string> PostStringAsync(string url, string data, Encoding encoding, string contentType)
        {
        ...
        {
            return await SendAsync(url, xml, encoding, encoding, "POST", "text/xml", certificate2);
        }

        public static async Task<string> SendAsync(string url, string data, Encoding requestEncoding, Encoding responseEncoding, string method, string contentType, X509Certificate2 certificate2 = null)
        {
            ...
            try
            {
                ...
                var sendBytes = requestEncoding.GetBytes(data);
                ...
                {
                    using (StreamReader reader = new StreamReader(resStream, responseEncoding))
                    {
