...
namespace Egoal.Tickets
{
    public static class TicketSaleExtensions
    {
        ...
        public static TicketSale CopyTo(this TicketSale originalTicketSale, TicketSale ticketSale)
        {
            ...
            ticketSale.PromoterId = originalTicketSale.PromoterId;
        ...
        public static TicketSalePhoto MapToTicketSalePhoto(this TicketSale ticketSale)
        {
            var ticketSalePhoto = new TicketSalePhoto();
            ticketSalePhoto.TicketTypeTypeId = ticketSale.TicketTypeTypeId;
            ticketSalePhoto.TicketTypeId = ticketSale.TicketTypeId;
            ticketSalePhoto.TicketId = ticketSale.Id;
            ticketSalePhoto.TradeId = ticketSale.TradeId;
            ticketSalePhoto.Stime = ticketSale.Stime;
            ticketSalePhoto.Etime = ticketSale.Etime;
            ticketSalePhoto.CashierId = ticketSale.CashierId;
            ticketSalePhoto.SalePointId = ticketSale.SalePointId;
            ticketSalePhoto.RegCashPcId = ticketSale.CashPcid;
            ticketSalePhoto.ParkId = ticketSale.ParkId;

            return ticketSalePhoto;
        }
    }
}
