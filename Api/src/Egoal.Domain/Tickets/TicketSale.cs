...
namespace Egoal.Tickets
{
    public class TicketSale : Entity<long>
    {
        ...
        public DateTime? FingerprintBindTime { get; set; }
        public bool? PhotoBindFlag { get; set; }
        public DateTime? PhotoBindTime { get; set; }
        public int? PhotoBindType { get; set; }
        ...
        public virtual ICollection<TicketGroundType> TicketGroundTypes { get; set; }
        ...
        public virtual ICollection<TicketGroundSale> TicketGroundSales { get; set; }
        public virtual ICollection<TicketSalePhoto> TicketSalePhotos { get; set; }
        public virtual ICollection<MemberCard> MemberCards { get; set; }

        public void AddTicketGroundType(TicketGroundType ticketGroundType)
        {
            if (TicketGroundTypes == null)
            {
                TicketGroundTypes = new List<TicketGroundType>();
            }

            TicketGroundTypes.Add(ticketGroundType);
        }

        public void AddTicketSaleBuyer(TicketSaleBuyer ticketSaleBuyer)
        {
            if (TicketSaleBuyers == null)
            {
                TicketSaleBuyers = new List<TicketSaleBuyer>();
            }

            TicketSaleBuyers.Add(ticketSaleBuyer);
        }

        public void AddTicketSaleSeat(TicketSaleSeat ticketSaleSeat)
        {
            if (TicketSaleSeats == null)
            {
                TicketSaleSeats = new List<TicketSaleSeat>();
            }

            TicketSaleSeats.Add(ticketSaleSeat);
        }

        public void AddTicketSaleGroundSharing(TicketSaleGroundSharing ticketSaleGroundSharing)
        {
            if (TicketSaleGroundSharings == null)
            {
                TicketSaleGroundSharings = new List<TicketSaleGroundSharing>();
            }

            TicketSaleGroundSharings.Add(ticketSaleGroundSharing);
        }

        public void AddTicketGroundSale(TicketGroundSale ticketGroundSale)
        {
            if (TicketGroundSales == null)
            {
                TicketGroundSales = new List<TicketGroundSale>();
            }

            TicketGroundSales.Add(ticketGroundSale);
        }
