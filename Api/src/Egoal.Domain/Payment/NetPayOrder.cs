...
namespace Egoal.Payment
{
    public class NetPayOrder : Entity<long>
    {
        ...
        {
            return OrderStatusId.IsIn(NetPayOrderStatus.未支付, NetPayOrderStatus.用户支付中, NetPayOrderStatus.支付失败);
        }
        ...
        public DateTime GetExpireTime(int minutes)
        {
            return Ctime.AddMinutes(minutes);
        }
    }
}
