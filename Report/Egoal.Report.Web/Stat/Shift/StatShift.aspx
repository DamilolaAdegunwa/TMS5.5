<%@ Page Language="C#" Async="true" AutoEventWireup="true" CodeBehind="StatShift.aspx.cs" Inherits="Egoal.Report.Web.Stat.Shift.StatShift" %>
...
<head runat="server">
    ...
    <title></title>
    <link href="../../Content/index.css?v=<%=CssVersion %>" rel="stylesheet" />
</head>
<body>
