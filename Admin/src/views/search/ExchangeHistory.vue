  ...
  <div class="main-content search-content">
    <div class="search-box" :class="{ 'search-box-collapse': !showAdvanced }">
      <el-form ref="searchForm" :model="input" :rules="rules" label-width="90px">
        <el-row type="flex">
          ...
          <el-col :sm="sm" :md="md" :lg="lg" class="col-xl">
            <el-form-item label="原票号">
              <el-input v-model="input.oldTicketCode" clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :sm="sm" :md="md" :lg="lg" class="col-xl">
    ...
    <div ref="tableBox" class="table-box">
      <el-table :data="tableData" border stripe :height="tableHeight" v-loading="loading">
        ...
        <el-table-column prop="orderListNo" min-width="150" label="订单号"></el-table-column>
        <el-table-column prop="ticketTypeName" min-width="180" label="票类"></el-table-column>
        <el-table-column prop="oldTicketCode" min-width="150" label="原票号"></el-table-column>
        <el-table-column prop="oldCardNo" min-width="150" label="原卡号"></el-table-column>
        <el-table-column prop="newTicketCode" min-width="150" label="换票后票号"></el-table-column>
        <el-table-column prop="newCardNo" min-width="150" label="换票后卡号"></el-table-column>
        <el-table-column prop="tkname" min-width="100" label="票介质"></el-table-column>
...
export default {
  ...
  methods: {
    async getData(input) {
      return await ticketService.queryExchangeHistoryAsync(input);
    },
    reset() {
